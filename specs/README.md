...
- `specs/active/` — **specs for work in flight**: planned or in-progress features, describing
  *intended* behavior. A spec is promoted out of `active/` once it ships. It emptied at 2.0 — the
  full-map renderer, the scheduling gate and structured schedule input all shipped and now sit
  alongside the rest — and currently holds `frontline.md`.
