...
- `specs/active/` — **specs for work in flight**: planned or in-progress features, describing
  *intended* behavior. A spec is promoted out of `active/` once it ships. Empty as of 2.1 — the
  full-map renderer, the scheduling gate and structured schedule input emptied it at 2.0, and the
  frontline overlay has since shipped and joined them.
